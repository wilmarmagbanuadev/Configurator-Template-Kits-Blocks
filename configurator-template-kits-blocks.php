<?php
/**
 * Plugin Name: Configurator Template Kits Blocks
...
function configurator_template_kits_blocks_action_links( $actions ) {
   $actions[] = '<a href="http:configurator-template-kits-blocks.com" target="_blank" style="color:red;font-weight:900;">Go Pro</a>';
   return $actions;
}
