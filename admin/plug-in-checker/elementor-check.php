...
function configurator_template_kits_blocks_fail_load() {
	...
	if ( _is_elementor_installed() ) {
		...
		$message  = '<p>' . __( 'Configurator Template Kits Blocks is not working because you need to activate the Elementor plugin.', 'configurator-template-kits-blocks' ) . '</p>';
		...
		$message  = '<p>' . __( 'Configurator Template Kits Blocks is not working because you need to install the Elementor plugin', 'configurator-template-kits-blocks' ) . '</p>';
...
function configurator_template_kits_blocks_fail_load_out_of_date() {
	...
	$message      = '<p>' . __( 'Configurator Template Kits Blocks is not working because you are using an old version of Elementor.', 'configurator-template-kits-blocks' ) . '</p>';
